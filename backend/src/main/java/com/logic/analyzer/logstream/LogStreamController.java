...
public class LogStreamController {
    ...
    private final LogStreamEmitterService emitterService;

    public LogStreamController(LogQueryService queryService, LogStreamEmitterService emitterService) {
    ...
    /** Push-based live tail: new entries matching these same filters are sent as SSE "logs" events as they're found. */
